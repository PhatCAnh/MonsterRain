...
namespace ArbanFramework.Config
{
    public class CsvConfigReader : IConfigReader
    {
        ...
        {
            float val = 0;
            float.TryParse(Read(), NumberStyles.Any, CultureInfo.InvariantCulture, out val);
            return val;
        }
        ...
        {
            double val = 0;
            double.TryParse(Read(), NumberStyles.Any, CultureInfo.InvariantCulture, out val);
            return val;
        }
        ...
        public double[] ReadDoubleArr()
        {
            return ReadArray().ConvertAll(str => {
                double val = 0;
                double.TryParse(str, NumberStyles.Any, CultureInfo.InvariantCulture, out val);
                return val;
            }).ToArray();
        }
